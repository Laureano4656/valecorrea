...
const Play: React.FC<iconType> = ({ size, color, background }) => {
  return (
    <svg width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.01 19">
      <g>
        <g>
          <path d="M9.51,19A9.5,9.5,0,0,1,2,3.7l.25-.31a8.86,8.86,0,0,1,.9-.93,6.59,6.59,0,0,1,.65-.54A10.48,10.48,0,0,1,5.23,1,9.41,9.41,0,0,1,9,0,9.37,9.37,0,0,1,15.82,2.4,9.61,9.61,0,0,1,19,9h0a9.38,9.38,0,0,1-2.41,6.86A9.55,9.55,0,0,1,10,19Zm0-17.43H9.14A8,8,0,0,0,3.65,4.15,7.86,7.86,0,0,0,1.57,9.86a8,8,0,0,0,8.29,7.57h0a8,8,0,0,0,7.57-8.29A7.8,7.8,0,0,0,14.91,3.7,8,8,0,0,0,9.47,1.57Z" />
