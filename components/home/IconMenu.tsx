...
export const IconMenu: React.FC<iconType> = ({
  ...
  return (
    <Link
      href={link}
      className={`absolute animate-fadeIn  duration-300  w-8 h-8 md:w-[4vw] md:h-[4vw] flex justify-center items-center  rounded-full border-[1px] border-black cursor-pointer  ${className} `}
    >
